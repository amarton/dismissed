var app = app || {
	...
	share: function(){
		...
		$(".icon-twitter").on("click", function(){
			...
			var tweet = "Dismissed: Tenants lose, landlords win in Baltimore's rent court. %23rentcourt"; //Tweet text
		...
		$(".icon-facebook").on("click", function(){
			...
			var title = "Dismissed: Tenants lose, landlords win in Baltimore's rent court"; //Post title
